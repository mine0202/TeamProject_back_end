...
public class UserDetailsImpl implements UserDetails, OAuth2User {
    ...
    private String names; // 개발자 추가 속성
    private String gender;
    private String email; // 개발자 추가 속성
    private String phone; // 개발자 추가 속성
    private String birthDate; // 개발자 추가 속성
    ...
    public UserDetailsImpl(Long id, String username,String names,String phone,String gender, String email, String birthDate, String password,
